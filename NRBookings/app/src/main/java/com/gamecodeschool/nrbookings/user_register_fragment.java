...
public class user_register_fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        databaseDrivers= FirebaseDatabase.getInstance().getReference("Driver Credentials");
                    ...
                    mAuth.createUserWithEmailAndPassword(Email,Password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            if (task.isSuccessful())
                            {
                                ...
                                Navigation.findNavController(view).navigate(R.id.user_login_fragment);
                            }
                            else
                            {
    ...
    private void addCredentials()
    {
       ...
       String dEmail,dPhn,dName;
       dEmail=etEmail.getText().toString().trim();
       dPhn=etPhn.getText().toString().trim();
       dName=etName.getText().toString().trim();
       UserCredentials_java_class driverCredentials=new UserCredentials_java_class(id,dEmail,dPhn,dName);
       databaseDrivers.child(id).setValue("Driver Credentials");
    }
